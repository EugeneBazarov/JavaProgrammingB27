...
public class VariablePractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(age);// printing the age variable, which means I print the value of the variable
        System.out.println("age");// this prints the characters age, not the variable that has a number value
        System.out.println("20");// printing the characters 2 and 0
        ...
        //byte num = 200; is too big for byte types
