...
public class TypeCasting {
    public static void main(String[] args) {
        ...
        long l2 = 300000000000L; // 300000000000 is int by default, but it is too big for int type,  so we need to tell the compiler it is a long type with the L

        float f = 10; // 10 is int by default, int is smaller than float, so it will automatically be cast
        System.out.println(f);

        double d = 19.99;
        int i2 = (int)d; // double is bigger than int, so I will ween to cast to int
        ...
        float f2 = (float)100.50f; // or you can do 100.50f;
        long l3 = (long)f2;
